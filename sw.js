const CACHE='rivfree-shell-v3';
const SHELL=['./','index.html','styles.css','app.js','features.js','catalog.js','catalog-cache.js','catalog-worker.js','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','data/stores.json','data/exchange.json'];
